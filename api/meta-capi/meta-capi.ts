...
    // Somente POST
    if (req.method !== 'POST') {
      // Adiciona o cabeçalho CORS para requisições que não são POST
      res.setHeader('Access-Control-Allow-Origin', '*');
      return res.status(405).json({ error: 'Method Not Allowed' });
    }

    // Adiciona o cabeçalho CORS para todas as requisições bem-sucedidas
    res.setHeader('Access-Control-Allow-Origin', 'https://santostecpromo.com.br');
